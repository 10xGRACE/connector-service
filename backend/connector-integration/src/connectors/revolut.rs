...
use transformers::{
    RevolutCaptureRequest, RevolutIncrementalAuthRequest, RevolutOrderCreateRequest,
    ...
    RevolutOrderCreateResponse as RevolutIncrementalAuthResponse, RevolutRefundRequest,
