...
// ===== MIT (SetupMandate and RepeatPayment) IMPLEMENTATIONS =====

// SetupMandate flow - creates initial charge with payment source to store mandate
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billwerk,
...
// RepeatPayment flow - creates subsequent charge using stored payment method
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billwerk,
