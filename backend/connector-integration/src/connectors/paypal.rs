...
use crate::{
    connectors::paypal::transformers::{
        ...
        PaypalAuthUpdateResponse, PaypalCaptureResponse, PaypalIncrementalAuthRequest,
        PaypalIncrementalAuthResponse, PaypalPaymentsCancelResponse, PaypalPaymentsCaptureRequest,
