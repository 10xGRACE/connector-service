...
use transformers::{JpmorganRepeatPaymentResponse, JpmorganSetupMandateResponse};
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            flow: RepeatPayment,
            request_body: JpmorganRepeatPaymentRequest,
...
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Jpmorgan,
    curl_request: Json(JpmorganRepeatPaymentRequest),
